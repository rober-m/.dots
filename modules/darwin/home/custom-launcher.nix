{
  ...
  options = {
    customized.custom-launcher.enable =
      lib.mkEnableOption "Enable cusom-launcher (script needs to be added to keybindings)";
  };

  config = lib.mkIf config.customized.custom-launcher.enable {
